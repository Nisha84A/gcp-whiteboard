    ...
    <header className="h-14 bg-navy-900 border-b border-slate-700 flex items-center justify-between px-4 shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:flex flex-col">
          <span className="text-sm font-bold text-white leading-tight">ABC-2024-001</span>
          <span className="text-[10px] text-slate-400 leading-tight">
            Efficacy & Safety of Drug ABC/XYZ in T2D · Phase 3 · Randomized, Double-Blind · 8 Subjects
          </span>
        </div>
      </div>
